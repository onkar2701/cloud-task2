...
resource "aws_instance" "myos" {
  ...
  connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/HP/Downloads/cloud-task.pem")
...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/onkar2701/cloud-task-1.git /var/www/html/"
    ]
  }
}
